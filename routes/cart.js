...
router.post('/save', function(req, res, next) {
  ...
  let products = [];
  let html = '<h4>Bạn đã đặt hàng thành công tại clover shop.</h4><p>Cảm ơn bạn đã ủng hộ clover shop!!! Hi vọng bạn sẽ có những trải nghiệm tốt tại hệ thống cửa hàng</p><p>Đơn hàng của bạn</p><table> <thead> <tr> <th>sản phẩm</th><th>thành tiền</th></tr></thead><tbody>';
